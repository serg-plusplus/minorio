...
"use client";
const configEnv = {"deviceSizes":[640,750,828,1080,1200,1920,2048,3840],"imageSizes":[16,32,48,64,96,128,256,384],"path":"/minorio/_next/image","loader":"default","dangerouslyAllowSVG":false,"unoptimized":true};
...
function Home() {
    (0,react__WEBPACK_IMPORTED_MODULE_3__.useEffect)(()=>{
        (async ()=>{
            ...
            const { Square  } = await __webpack_require__.e(/* import() */ 574).then(__webpack_require__.bind(__webpack_require__, 5574));
            // Update this to use the address (public key) for your zkApp account
            // To try it out, you can try this address for an example "Add" smart contract that we've deployed to
            // Berkeley Testnet B62qqkb7hD1We6gEfrcqosKt9C398VLp1WXeTo1i9boPoqF7B1LxHg4
            const zkAppAddress = "B62qpgrkCC8tgDRXCpsr1YhwSu5pNxWf98vK5n91SBiXxu7qC2Uy9Ur";
            // This should be removed once the zkAppAddress is updated.
            if (!zkAppAddress) {
                console.error('The following error is caused because the zkAppAddress has an empty string as the public key. Update the zkAppAddress with the public key for your zkApp account, or try this address for an example "Add" smart contract that we deployed to Berkeley Testnet: B62qqkb7hD1We6gEfrcqosKt9C398VLp1WXeTo1i9boPoqF7B1LxHg4');
            }
            const zkAppInstance = new Square(snarkyjs__WEBPACK_IMPORTED_MODULE_4__/* .PublicKey.fromBase58 */ .nh.fromBase58(zkAppAddress));
        })();
    }, []);
