...
const functions = {
    ...
    loadContract: async (args)=>{
        const { Square  } = await __webpack_require__.e(/* import() */ 810).then(__webpack_require__.bind(__webpack_require__, 8810));
        state.Square = Square;
    },
    ...
    createUpdateTransaction: async (args)=>{
        const transaction = await snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .Mina.transaction */ .No.transaction(()=>{
            state.zkapp.update(snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .Field.fromJSON */ .gN.fromJSON(args.square));
        });
...
/******/ 			return "static/chunks/" + (chunkId === 829 ? "cc8f0cfa" : chunkId) + "." + {"810":"710f0893b68fa433","829":"71afa41f2f0507d4"}[chunkId] + ".js";
/******/ 		};
/******/ 	}();
/******/ 	
...
/******/ 	!function() {
/******/ 		__webpack_require__.p = "/minorio//_next/";
/******/ 	}();
/******/ 	
